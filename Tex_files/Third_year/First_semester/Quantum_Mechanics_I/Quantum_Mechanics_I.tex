...
\begin{empheq}[box=\tcbhighmath]{equation}
\begin{split}
   \left[ \sigma^{\alpha},\sigma^{\beta} \right] =2i \sum_{\gamma =1}^3\epsilon^{\alpha \beta \gamma}\sigma^{\gamma} \iff \left[\frac{\sigma^{\alpha}}{2i},\frac{\sigma^{\beta}}{2i} \right] = \sum_{\gamma=1}^3\epsilon^{\alpha \beta \gamma}\frac{\sigma^{\gamma}}{2i}
\end{split}
\end{empheq}
