...
\begin{itemize}
    ...
    \begin{align*}
    &|\mathcal{M}\left(e_L^+e_R^- \rightarrow q_L^+\bar{q}_R^-\right)|^2 = Q_f^2e^4(1+\cos \theta)^2 \\
         &|\mathcal{M}\left(e_R^+e_L^- \rightarrow q_R^+\bar{q}_L^-\right)|^2 = Q_f^2e^4(1+\cos \theta)^2 \\
        &|\mathcal{M}\left(e_L^+e_R^- \rightarrow q_R^+\bar{q}_L^-\right)|^2 = Q_f^2e^4(1-\cos \theta)^2 \\
        &|\mathcal{M}\left(e_R^+e_L^- \rightarrow q_L^+\bar{q}_R^-\right)|^2 = Q_f^2e^4(1-\cos \theta)^2
     \end{align*}
     The next step is to write these in terms if the Mandelstam variables: 
          \begin{align*}
    &|\mathcal{M}\left(e_L^+e_R^- \rightarrow q_L^+\bar{q}_R^-\right)|^2 = 4Q_f^2e^4\frac{u^2}{s^2} \\
         &|\mathcal{M}\left(e_R^+e_L^- \rightarrow q_R^+\bar{q}_L^-\right)|^2 = 4Q_f^2e^4\frac{u^2}{s^2} \\
        &|\mathcal{M}\left(e_L^+e_R^- \rightarrow q_R^+\bar{q}_L^-\right)|^2 =4Q_f^2e^4\frac{t^2}{s^2} \\
        &|\mathcal{M}\left(e_R^+e_L^- \rightarrow q_L^+\bar{q}_R^-\right)|^2 = 4Q_f^2e^4\frac{t^2}{s^2}
     \end{align*}
