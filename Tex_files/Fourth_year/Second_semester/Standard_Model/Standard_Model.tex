...
\hline
\textbf{Meson} & \textbf{Quark Composition} & \textbf{Isospin (I, I$_3$)} & \textbf{Mass (MeV)} \\
\hline
$\pi^+$ & $u\bar{d}$ & $(1, +1)$ & 139.57 \\
$\pi^0$ & $\frac{1}{\sqrt{2}}(u\bar{u} - d\bar{d})$ & $(1, 0)$ & 134.98 \\
$\pi^-$ & $d\bar{u}$ & $(1, -1)$ & 139.57 \\
\hline
$K^+$ & $u\bar{s}$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 493.68 \\
$K^0$ & $d\bar{s}$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 497.61 \\
$\bar{K}^0$ & $s\bar{d}$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 497.61 \\
$K^-$ & $s\bar{u}$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 493.68 \\
\hline
$\eta$ & $\frac{1}{\sqrt{6}}(u\bar{u} + d\bar{d} - 2s\bar{s})$ & $(0, 0)$ & 547.86 \\
$\eta'$ & Mixed state & $(0, 0)$ & 957.78 \\
\hline
\end{tabular}
\caption{Quark composition, isospin, and mass of common light mesons.}
\end{table}
...
\textbf{Meson} & \textbf{Quark Composition} & \textbf{Isospin (I, I$_3$)} & \textbf{Mass (MeV)} \\
\hline
$D^+$ & $c\bar{d}$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 1869.66 \\
$D^0$ & $c\bar{u}$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 1864.84 \\
$D_s^+$ & $c\bar{s}$ & $(0, 0)$ & 1968.34 \\
\hline
$B^+$ & $u\bar{b}$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 5279.34 \\
$B^0$ & $d\bar{b}$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 5279.63 \\
$B_s^0$ & $s\bar{b}$ & $(0, 0)$ & 5366.88 \\
$B_c^+$ & $c\bar{b}$ & $(0, 0)$ & 6274.9 \\
\hline
$J/\psi$ & $c\bar{c}$ & $(0, 0)$ & 3096.9 \\
$\Upsilon$ (1S) & $b\bar{b}$ & $(0, 0)$ & 9460.3 \\
\hline
\end{tabular}
\caption{Quark composition, isospin, and mass of common heavy mesons.}
\end{table}
...
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Baryon} & \textbf{Quark Composition} & \textbf{Isospin (I, I$_3$)} & \textbf{Mass (MeV)} \\
\hline
$p$ (Proton) & $uud$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 938.27 \\
$n$ (Neutron) & $udd$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 939.57 \\
\hline
$\Lambda^0$ & $uds$ & $(0, 0)$ & 1115.68 \\
$\Sigma^+$ & $uus$ & $(1, +1)$ & 1189.37 \\
$\Sigma^0$ & $uds$ & $(1, 0)$ & 1192.64 \\
$\Sigma^-$ & $dds$ & $(1, -1)$ & 1197.45 \\
\hline
$\Xi^0$ & $uss$ & $\left(\frac{1}{2}, +\frac{1}{2}\right)$ & 1314.86 \\
$\Xi^-$ & $dss$ & $\left(\frac{1}{2}, -\frac{1}{2}\right)$ & 1321.71 \\
\hline
$\Delta^{++}$ & $uuu$ & $\left(\frac{3}{2}, +\frac{3}{2}\right)$ & 1232 \\
$\Delta^+$ & $uud$ & $\left(\frac{3}{2}, +\frac{1}{2}\right)$ & 1232 \\
$\Delta^0$ & $udd$ & $\left(\frac{3}{2}, -\frac{1}{2}\right)$ & 1232 \\
$\Delta^-$ & $ddd$ & $\left(\frac{3}{2}, -\frac{3}{2}\right)$ & 1232 \\
\hline
\end{tabular}
\caption{Quark composition, isospin, and mass of common light baryons.}
\end{table}
