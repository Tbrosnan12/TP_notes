...
\centering
    \resizebox{0.3\textwidth}{!}{
        \begin{feynman}
    \fermion[label=$e^-$]{5.00, 5.00}{4.00, 4.00}
    \fermion[label=$e^+$]{6.00, 4.00}{5.00, 5.00}
    \electroweak[color=abb8c3]{5.00, 5.00}{5.00, 7.00}
    \fermion[label=$\mu^-$]{6.00, 8.00}{5.00, 7.00}
    \fermion[label=$\mu^+$]{5.00, 7.00}{4.00, 8.00}
\end{feynman}
    }
\end{figure}
