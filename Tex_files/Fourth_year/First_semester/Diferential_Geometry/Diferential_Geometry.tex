...
\begin{itemize}
  ...
  \begin{flalign*}
  \mathcal{L}_{\xi}T^{i_1,..,i_p}_{j_1,\ldots,j_q} = \left[\frac{d}{dt}(F_tT)^{i_1,..,i_p}_{j_1,\ldots,j_q}\right]_{t=0}
  \end{flalign*}
\end{itemize}

\subsubsection{Killing Vector} % (fold)
