...
\begin{itemize}
  ...
  \begin{align*}
   & \bra{0}T\left\{\phi(x)\phi(y)\text{exp}\left(-i\int_{-t}^{t}dt'H_{I}(t')\right)\right\}\ket{0}  \\
    ...
    &~~ + 12\left(-\frac{i\lambda}{4!}\right)\int d^4zD_{F}(x-z)D_F(y-z)D_F(z-z)
  \end{align*} 
...
\begin{tikzpicture}[scale=2]
  \begin{pgfonlayer}{nodelayer}
    \node [circle, fill, inner sep=1pt] (0) at (0, 0) {};
    \node [style=none] (1) at (0, 0) {};
    \node [circle, fill, inner sep=1pt] (2) at (0, -0.5) {};
  \end{pgfonlayer}
  \begin{pgfonlayer}{edgelayer}
