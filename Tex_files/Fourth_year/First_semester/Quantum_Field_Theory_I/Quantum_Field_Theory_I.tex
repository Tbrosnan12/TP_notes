...
\begin{itemize}
  \item We would now naturally like to find out what are the invariants we can make out of the spinors which transform via \ref{S_transform}. Let us first make the 
\end{itemize}
\end{document}