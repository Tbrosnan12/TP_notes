...
\begin{align*}
 ...
 \label{no_of_events}
  ...
  \begin{align*}
     &\int dk'^z_{\mathcal{A}}dk'^z_{\mathcal{B}}\delta\left(dk'^z_{\mathcal{A}}+dk'^z_{\mathcal{A}}-\sum p^{z}_f\right)\delta(E'_{\mathcal{A}}+E'_{\mathcal{B}}-\sum E_{f}) \\
     & = \int dk'^z_{\mathcal{A}}\delta(\sqrt{k'_{\mathcal{A}}^2+m_{\mathcal{A}^2}}+\sqrt{k'_{\mathcal{B}}^2+m_{\mathcal{B}^2}}-\sum E_{f}) \bigg\vert_{k'^z_{\mathcal{B}} = \sum p_f - k'^z_{\mathcal{A}}}  \\
     & = \frac{1}{||}
   \end{align*} 
   Where we have used the property of the delta function that:
   \begin{align*}
         &\delta(f(x)) = \frac{1}{|f'(x_0)|}\delta(x-x_0) \\
         \implies  & \delta(E_{\mathcal{A}}(k)+E_{\mathcal{B}}(k) - \sum E_{f}) = \frac{\delta(k)}{|dE_{\mathcal{A}}/dk+dE_{\mathcal{B}}/dk|}
     \end{align*}
\end{itemize}
