...
\begin{itemize}
   ...
   \begin{align*}
    ...
    \end{align*}
    Where in the second line we have used integration by parts. For the constraint to be consistent we must have that $\{\partial_iA^i,H\} = \partial^j\partial_jA^0$.  
\end{itemize}
