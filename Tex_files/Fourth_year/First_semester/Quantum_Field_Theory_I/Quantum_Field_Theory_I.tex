...
\begin{itemize}
  \item We wish to find a Hamiltonian for our field theory. The best way to go about extending our definition of $H =\sum_i p_i \dot{q}_i  - L(q,\dot{q})$, is to think of space as a discretized space, idexed by $i$. We can then calculate $p(\textbf{x}) = \frac{\partial L}{\partial \dot{\phi}} = $
\end{itemize}
