...
\begin{itemize}
  ...
  \begin{align*}
    ...
    \end{pmatrix} \delta(\textbf{x}-\textbf{y}) \implies (C^{ab}) = \begin{pmatrix}
      0 & 0& 1 & 0 \\
      0 & 0 & 0 & \frac{1}{\frac{\partial}{\partial x_k}\frac{\partial}{\partial y^k}} \\
      -1 & 0 & 0 & 0 \\ 
      0 & -\frac{1}{\frac{\partial}{\partial x_k}\frac{\partial}{\partial y^k}} & 0 & 0 
    \end{pmatrix} \frac{1}{\delta(\textbf{x}-\textbf{y})}
  \end{align*}
\end{itemize}
...
\begin{itemize}
  ...
  \end{align}
  We then need to calculate all the Poisson brackets of $\pi_i$ and $A^{j}$ with the constraints \ref{constraints_gauge}. For $\pi_i$ we can see the vanishing brackets are:
  \begin{align*}
    \{\pi_i,\pi_0\} &= 0 \\
...
\begin{align*}
  ...
  \begin{align*}
    ...
    & = \{\pi_i(\textbf{x}),A^j(\textbf{y})\}-\int d^3z_1\int d^3z_2\delta^k_i\left(\frac{\partial}{\partial y^k}\delta(\textbf{x}-\textbf{z}_1)\right)C^{42}(\textbf{z}_1,\textbf{z}_2)\delta^i_l\frac{\partial}{\partial y_l}\delta(\textbf{y}-\textbf{z}_2) \\
    & = \{\pi_i(\textbf{x}),A^j(\textbf{y})\}-\int d^3z_1\int d^3z_2\delta(\textbf{x}-\textbf{z}_1)\delta(\textbf{y}-\textbf{z}_2)\left(\frac{\partial}{\partial y^i}\frac{\partial}{\partial y_j}C^{42}(\textbf{z}_1,\textbf{z}_2)\right) \\
    & = \{\pi_i(\textbf{x}),A^j(\textbf{y})\}-\int d^3z_1\int d^3z_2\delta(\textbf{x}-\textbf{z}_1)\delta(\textbf{y}-\textbf{z}_2)\left(\frac{\partial}{\partial y^i}\frac{\partial}{\partial y_j}C^{42}(\textbf{z}_1,\textbf{z}_2)\right)
  \end{align*}
