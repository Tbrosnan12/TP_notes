...
\begin{itemize}
   ...
   \begin{align*}
      \frac{\partial H}{\partial \pi_j} = -\frac{\partial}{\partial E^j}\left(\frac{1}{2}E^2-E^i\partial_iA^0\right) = E^j - \partial_jA^0
    \end{align*} 
    Combining this with \ref{partial_A} we have:
    \begin{align*}
    ...
    \item With this we have found $4$ new constraints, the same number as arbitrary co-officiants in our total Hamiltonian due to the presence of $4$ first class constraints $\pi_0\approx 0$ and $\partial^i\pi_i \approx 0$. Together the constraints are:
    \begin{align*}  
