...
\begin{align*}
 ...
 \begin{align*}
   \braket{\textbf{p}_1\textbf{p}_2 \cdot \cdot \cdot|iT|\textbf{k}_{\mathcal{A}}\textbf{k}_{\mathcal{B}}} = i(2\pi)^4\delta^{(4)}(k_{\mathcal{A}}+k_{\mathcal{B}} - \sum_{f}p_f)\mathcal{M}(k_{\mathcal{A}},k_{\mathcal{B}}) \rightarrow \{p_f\}
 \end{align*}
 ...
 \label{no_of_events}
  ...
  \end{align*}
  Where we have integrals over $k$ and $k'$ as those terms are squared in \ref{prob_AB}. Carrying out he $b$ integral will give us the delta function $\delta^{(2)}(\textbf{k}_{\mathcal{B}}^{\perp}-\textbf{k}_{\mathcal{B}}^{'\perp})$. We can get more delta functions by 
\end{itemize}
