...
\begin{itemize}
  ...
  \item We will then consider what the interactions will look like for the scattering of fermions. The leading contribution to the interaction part of the $\hat{S}$ matrix will be from the quadratic term in the exponential. The reason the linear term does not contribute is there are not enough $\psi$'s to contract with each other and the final and initial momenta. For this we need at least $4$ $\psi$'s. We also need to contract This term takes the form:
  \begin{align*}
  ...
  \end{align*}
  Where just as in the last few chapters, the fields that appear in the exponential are the free fields denoted with the subscript ${}_{I}$, which we will drop from now on. We can 
\end{itemize}
