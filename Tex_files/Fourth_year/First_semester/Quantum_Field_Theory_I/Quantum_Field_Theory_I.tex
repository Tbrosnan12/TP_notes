...
\end{align*}
As we have no angular dependance. 
...
\begin{tikzpicture}[scale=1.5, decoration={markings, mark=at position 0.5 with {\arrow{stealth}}}]
    ...
    \draw [postaction={decorate},] (A.center) -- (X.center) node[midway,left] {\(p_1\)};
    ...
    \draw [postaction={decorate}] (X.center) -- (D.center) node[midway,right] {\(p_{\mathcal{B}}\)};
