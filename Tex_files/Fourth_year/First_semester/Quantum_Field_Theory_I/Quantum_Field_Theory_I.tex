...
\begin{itemize}
  ...
  \end{align*}
   What we need in the Dirac bracket is the inverse of this matrix. This is 
\end{itemize}
...
\begin{align*}
  ...
  \begin{align*}
    ...
    & = \{\pi_i(\textbf{x}),A^j(\textbf{y})\}+\int d^3z_1\int d^3z_2\delta(\textbf{x}-\textbf{z}_1)\delta(\textbf{y}-\textbf{z}_2)\left(\frac{\partial}{\partial x^i}\frac{\partial}{\partial y_j}C^{42}(\textbf{z}_1,\textbf{z}_2)\right) \\
    & = \{\pi_i(\textbf{x}),A^j(\textbf{y})\}+\left(\frac{\partial}{\partial x^i}\frac{\partial}{\partial y_j}\right)
  \end{align*}
