...
\begin{itemize}
  ...
  \label{test_prop}
   ...
   \end{align} 
   This second integral on the RHS is an integral along the real line and has two poles at $p^{0} = \pm E_{\textbf{p}}$, where $E_{\textbf{p}}^2 = \textbf{p}^2+m^2$. We can make these simple poles by expanding with partial fractions i.e.:
   \begin{align*}
