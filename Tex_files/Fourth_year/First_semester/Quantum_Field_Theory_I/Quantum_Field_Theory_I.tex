...
\begin{itemize}
  ...
  \end{align*}
\end{itemize}
In the previous case we had that the proportionality factor canceled out in the final formula leaving us with just the sum of all diagrams with two external points. We will posit for simplicity that the same happens for this case. 
